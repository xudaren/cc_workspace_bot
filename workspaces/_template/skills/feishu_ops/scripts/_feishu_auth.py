...
凭证路径：{workspace}/skills/feishu_ops/feishu.json
由框架 workspace.Init() 在启动时写入，不暴露给 LLM。
...
# 凭证文件与 scripts/ 同级：{workspace}/skills/feishu_ops/feishu.json
